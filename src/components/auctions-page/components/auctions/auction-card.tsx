    ...
    return (
        <Link to={`${APP_ROUTES.AUCTION.replace(":id", auction.id + "")}`}>
            <div className={styles.auctionCard}>
                <div className={styles.auctionCard__img}>
                    {auction.images[0]?.photo ? (
                        ...
                        <svg
                            className={styles.auctionCard__noImage}
                ...
                <span
                    className={
                        styles[
                            `auctionCard__status${auction.started ? (auction.finished ? "--finished" : "--ongoing") : "--notStarted"}`
                        ]
                    }
                >
                    {auction.started
